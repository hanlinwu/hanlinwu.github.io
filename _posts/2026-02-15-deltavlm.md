...
tags: [remote-sensing, vision-language-model, change-detection]
categories: [research]
thumbnail: /assets/img/publication_preview/2026-RS-DeltaVLM.png
related_publications: true
---

传统的遥感变化检测方法通常只能输出二值变化图，告诉我们"哪里变了"，却无法回答"发生了什么变化"、"变化程度如何"等更深层的问题。随着视觉语言模型（VLM）的发展，我们是否能让模型像人类分析师一样，以对话的方式灵活地分析遥感影像中的变化？

在我们发表于 *Remote Sensing* 的工作 **DeltaVLM** {% cite deng2026deltavlm %} 中，我们提出了一种基于指令引导的交互式遥感影像变化分析框架，旨在通过自然语言指令驱动模型对双时相影像进行多维度的变化理解。
...
<img src="/assets/img/publication_preview/2026-RS-DeltaVLM.png" alt="DeltaVLM Framework" style="width: 100%; max-width: 800px; display: block; margin: 0 auto; border-radius: 6px;">
...
论文和代码已公开：
- 论文：[Remote Sensing](https://www.mdpi.com/2072-4292/18/4/541)
- 代码：[GitHub](https://github.com/hanlinwu/DeltaVLM)
